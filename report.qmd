...
We will use data from the introduction of the `at or within the spread` rule in November 2011. However, since our investigation found that there were no internal crossings in 2011, we will use data from 2012 until the end of 2015. This ensures a similar length of the investigation period before and after the rule change on 26 May 2013.
...
- how many internal crossings before 26 may 2013, show the proportion and dollar value (monthly table), also show the  whole period
- how many internal crossings after 26 may 2013, show the proportion and dollar value (monthly table), also show the whole period
- show the time series barplot to compare movement of At-the-Spread internal Crossings
- there is apparent changes, but still some violation

*Economic Implication*

- explain the change of the dollar value for whole period
